...
CREATE TABLE `sys_articles`  (
  ...
  `introduction` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '文章摘要',
  `user_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '作者id',
  `comment_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '评论id',
  `icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'icon',
  `icon_color` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'icon颜色',
  ...
  `view_count` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '浏览量',
  `original_link` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '原文链接',
  `tag_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '标签id',
  `classification_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '分类id',
  `view_password` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '阅读密码',
  `is_comment` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '是否开启评论',
  `comment_count` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '评论量',
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0' COMMENT '状态',
  `is_password` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0' COMMENT '是否需要密码',
  `transfer_rules` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0' COMMENT '转载规则设置',
  `cover_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0' COMMENT '封面类型',
  `top` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '0' COMMENT '是否置顶',
  `article_html` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_sys_articles_deleted_at`(`deleted_at`) USING BTREE
) ENGINE = MyISAM CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_articles
-- ----------------------------
INSERT INTO `sys_articles` VALUES (1, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '需要密码的文章', '描述描述描述描述描述描述描述描述描述描述描述描述描述描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, 'uv-warning', NULL, NULL, '# 作用\r\n\r\n都是用来改变上下文,换句话就是为了改变函数体内 this 指向\r\n\r\n# 参数\r\n\r\n```\r\napply(thisObj, [arg1, arg2, arg3, arg4]);\r\ncall(thisObj, arg1, arg2, arg3, arg4)\r\n```\r\n\r\neg:\r\n\r\n````\r\n var func = function (a, b, c) {\r\n      console.log(a, b, c);\r\n    };\r\n    func.apply(null, [1, 2, 3]); //1 2 3\r\n    func.call(null, 4, 5, 6); //4 5 6\r\n```\r\n\r\n````\r\n# 区别\r\n\r\n## 参数\r\n\r\n`call` 是包装在 `apply` 上面的一颗语法糖，如果我们明确地知道函数接受多少个参数，而且想\r\n一目了然地表达形参和实参的对应关系，那么也可以用 `call` 来传送参数\r\n\r\n> 当时用 call 或者 apply 的时候,如果我们传入的第一个参数为 `null`,函数体内的 `this` 会指向默认的宿主对象,在浏览器中则是 window,但是如果在严格模式下` \"use strict\";``this ` 还是 `null`\r\n\r\n# 用途\r\n\r\n## 1.改变 `this` 指向\r\n\r\n```\r\n\r\n   var obj1 = {\r\n      name: \"张三\",\r\n    };\r\n    var obj2 = {\r\n      name: \"李四\",\r\n    };\r\n    window.name = \"王五\";\r\n    var getName = function () {\r\n      console.log(this.name);\r\n    };\r\n    getName(); //王五\r\n    getName.call(obj1); //张三,执行这句getName函数内的this就指向了obj1对象\r\n    getName.call(obj2); //李四\r\n\r\n```\r\neg:\r\n\r\n```\r\n\r\n document.getElementById(\"div1\").onclick = function () {\r\n      var func = function () {\r\n        console.log(this.id); //undefined\r\n      };\r\n      func();\r\n    };\r\n\r\n```\r\n这种情况丢失了 `this` 指向问题\r\n解决办法:\r\n\r\n> 办法 1:\r\n\r\n```\r\n\r\ndocument.getElementById(\"div1\").onclick = function () {\r\n      var func = function () {\r\n        console.log(this.id); //undefined\r\n      };\r\n      func().call(this);\r\n    };\r\n\r\n```\r\n> 办法 2\r\n\r\n```\r\n\r\ndocument.getElementById = (function( func ){\r\n    return function(){\r\n        return func.apply( document, arguments );\r\n        }\r\n})( document.getElementById );\r\nvar getId = document.getElementById;\r\nvar div = getId( \'div1\' );\r\nalert ( div.id );\r\n\r\n```\r\n> 办法 3\r\n\r\n```\r\n\r\n  document.getElementById(\"div1\").onclick = function () {\r\n      var that = this;\r\n      var func = function () {\r\n        console.log(that.id); //undefined\r\n      };\r\n      func();\r\n    };\r\n\r\n```\r\n# 办法 3 拓展 `Function.prototype.bind`\r\n\r\n手动实现\r\n\r\n```\r\n\r\nFunction.prototype.bind = function( context ){\r\n  var self = this; // 保存原函数\r\n  return function(){ // 返回一个新的函数\r\n    return self.apply( context, arguments ); // 执行新的函数的时候，会把之前传入的 context\r\n    // 当作新函数体内的 this\r\n  }\r\n};\r\nvar obj = {\r\n  name: \'sven\'\r\n};\r\nvar func = function(){\r\n  alert ( this.name ); // 输出：sven\r\n}.bind( obj);\r\nfunc()\r\n\r\n```\r\n# 借用其他对象,类似继承\r\n\r\neg:\r\n\r\n```\r\n\r\nvar A = function (name) {\r\n      console.log(this); //this已经指向B\r\n      this.name = name;\r\n    };\r\n    var B = function () {\r\n      A.apply(this, arguments);\r\n    };\r\n    B.prototype.getName = function () {\r\n      return this.name;\r\n    };\r\n    var b = new B(\"张三\");\r\n    console.log(b.getName());\r\n\r\n```\r\n\r\n```', NULL, NULL, NULL, NULL, '1165', NULL, NULL, '0', '1', '0', '1', '0', NULL);
INSERT INTO `sys_articles` VALUES (2, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '22222', '描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, 'https://gitee.com/Uvdream/images/raw/master/images/20200806150710.png', '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '1', '0', NULL);
INSERT INTO `sys_articles` VALUES (3, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '333333', '描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, 'https://gitee.com/Uvdream/images/raw/master/images/20200806150710.png', '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '3', '0', NULL);
INSERT INTO `sys_articles` VALUES (4, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '44444', '描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, NULL, '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '4', '0', NULL);
INSERT INTO `sys_articles` VALUES (5, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '55555', '描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, NULL, '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0', '0', NULL);
INSERT INTO `sys_articles` VALUES (6, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '666', '描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, NULL, '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0', '0', NULL);
INSERT INTO `sys_articles` VALUES (7, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '7777', '描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, NULL, '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0', '0', NULL);
INSERT INTO `sys_articles` VALUES (8, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '88888', '描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, NULL, '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0', '0', NULL);
INSERT INTO `sys_articles` VALUES (9, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '9999', '描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, NULL, '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0', '0', NULL);
INSERT INTO `sys_articles` VALUES (10, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '10', '描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, NULL, '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '1', '0', NULL);
INSERT INTO `sys_articles` VALUES (11, '2020-09-04 17:22:46', '2020-09-04 17:22:46', NULL, '最后一片', '描述描述描述描述描述描述描述描述描述描述描述描述描述描述', 'ce0d6685-c15f-4126-a5b4-890bc9d2356d', NULL, NULL, NULL, 'https://gitee.com/Uvdream/images/raw/master/images/20200806150710.png', '# 闭包和面向对象\r\n\r\n## 闭包写法\r\n\r\n```\r\n    var extent = function () {\r\n      var value = 0;\r\n      return {\r\n        call: function () {\r\n          value++;\r\n          console.log(value);\r\n        },\r\n      };\r\n    };\r\n    var extent = extent();\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 1\r\n\r\n```\r\n    var extent = {\r\n      value: 0,\r\n      call: function () {\r\n        this.value++;\r\n        console.log(this.value);\r\n      },\r\n    };\r\n    extent.call();\r\n    extent.call();\r\n```\r\n\r\n## 面向对象 2\r\n\r\n```\r\n  var extent = function () {\r\n      this.value = 0;\r\n    };\r\n    extent.prototype.call = function () {\r\n      this.value++;\r\n      console.log(this.value);\r\n    };\r\n    var extent = new extent();\r\n    extent.call();\r\n```\r\n\r\n# 高阶函数\r\n\r\n## 函数可以作为参数被传递\r\n\r\n### 1.回调函数\r\n\r\n```\r\nvar getUserInfo = function( userId, callback ){\r\n    $.ajax( \'http://xxx.com/getUserInfo?\' + userId, function( data ){\r\n      if ( typeof callback === \'function\' ){\r\n        callback( data );\r\n      }\r\n    });\r\n}\r\ngetUserInfo( 13157, function( data ){\r\n  alert ( data.userName );\r\n});\r\n```\r\n\r\n### 2.Array.prototype.sort\r\n\r\n```\r\n//   从小到大\r\n    [1, 5, 3].sort(function (a, b) {\r\n      return a - b;\r\n    });\r\n```\r\n\r\n## 函数可以作为返回值输出\r\n\r\n### 判断类型\r\n\r\n> 初级\r\n\r\n```\r\nvar isString = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object String]\';\r\n};\r\nvar isArray = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Array]\';\r\n};\r\nvar isNumber = function( obj ){\r\n  return Object.prototype.toString.call( obj ) === \'[object Number]\';\r\n};\r\n```\r\n\r\n> 中级\r\n\r\n```\r\nvar isType = function( type ){\r\n  return function( obj ){\r\n    return Object.prototype.toString.call( obj ) === \'[object \'+ type +\']\';\r\n  }\r\n};\r\nvar isString = isType( \'String\' );\r\nvar isArray = isType( \'Array\' );\r\nvar isNumber = isType( \'Number\' );\r\nconsole.log( isArray( [ 1, 2, 3 ] ) );\r\n```\r\n\r\n> 高级\r\n\r\n```\r\n    var Type = {};\r\n    for (var i = 0, type; (type = [\"String\", \"Array\", \"Number\"][i++]); ) {\r\n      (function (type) {\r\n        Type[\"is\" + type] = function (obj) {\r\n          return (\r\n            Object.prototype.toString.call(obj) === \"[object \" + type + \"]\"\r\n          );\r\n        };\r\n      })(type);\r\n    }\r\n    Type.isArray([]); // 输出：true\r\n    Type.isString(\"str\"); // 输出：true\r\n```\r\n\r\n# 高阶函数实现 `AOP`\r\n\r\n```\r\nFunction.prototype.before = function (beforefn) {\r\n      console.log(this);\r\n      //   此处this指向原函数\r\n      var __self = this;\r\n      return function () {\r\n        //   此处this指向window\r\n        console.log(this);\r\n        beforefn.apply(this, arguments); //   执行新函数,修正this指向\r\n        return __self.apply(this, arguments); //执行旧函数\r\n      };\r\n    };\r\n    Function.prototype.after = function (afterfn) {\r\n      var __self = this;\r\n      return function () {\r\n        var ret = __self.apply(this, arguments); //执行旧函数\r\n        afterfn.apply(this, arguments); //执行新函数\r\n        return ret; //返回旧函数\r\n      };\r\n    };\r\n    var func = function () {\r\n      console.log(2);\r\n    };\r\n    func = func\r\n      .before(function () {\r\n        console.log(1);\r\n      })\r\n      .after(function () {\r\n        console.log(3);\r\n      });\r\n    func();\r\n```\r\n\r\n## 函数节流\r\n\r\n```\r\nvar throttle = function (fn, interval) {\r\n      var __self = fn, // 保存需要被延迟执行的函数引用\r\n        timer, // 定时器\r\n        firstTime = true; // 是否是第一次调用\r\n      return function () {\r\n        var args = arguments,\r\n          __me = this;\r\n        if (firstTime) {\r\n          // 如果是第一次调用，不需延迟执行\r\n          __self.apply(__me, args);\r\n          return (firstTime = false);\r\n        }\r\n        if (timer) {\r\n          // 如果定时器还在，说明前一次延迟执行还没有完成\r\n          return false;\r\n        }\r\n        timer = setTimeout(function () {\r\n          // 延迟一段时间执行\r\n          clearTimeout(timer);\r\n          timer = null;\r\n          __self.apply(__me, args);\r\n        }, interval || 500);\r\n      };\r\n    };\r\n    window.onresize = throttle(function () {\r\n      console.log(1);\r\n    }, 500);\r\n```\r\n\r\n## 分时函数\r\n\r\n```\r\n var timeChunk = function (ary, fn, count) {\r\n      var obj, t;\r\n      var len = ary.length;\r\n      var start = function () {\r\n        for (var i = 0; i < Math.min(count || 1, ary.length); i++) {\r\n          var obj = ary.shift();\r\n          fn(obj);\r\n        }\r\n      };\r\n      return function () {\r\n        t = setInterval(function () {\r\n          if (ary.length === 0) {\r\n            // 如果全部节点都已经被创建好\r\n            return clearInterval(t);\r\n          }\r\n          start();\r\n        }, 200); // 分批执行的时间间隔，也可以用参数的形式传入\r\n      };\r\n    };\r\n```\r\n\r\n```\r\n var ary = [];\r\n    for (var i = 1; i <= 1000; i++) {\r\n      ary.push(i);\r\n    }\r\n    var renderFriendList = timeChunk(\r\n      ary,\r\n      function (n) {\r\n        var div = document.createElement(\"div\");\r\n        div.innerHTML = n;\r\n        document.body.appendChild(div);\r\n      },\r\n      8\r\n    );\r\n```\r\n\r\n> 虚拟列表原理类似\r\n\r\n<iframe width=\"100%\" height=\"300\" src=\"//jsfiddle.net/UvDream/kourjdb1/2/embedded/js,result/\" allowfullscreen=\"allowfullscreen\" allowpaymentrequest frameborder=\"0\"></iframe>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '2', '1', NULL);
